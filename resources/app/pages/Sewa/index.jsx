...
import { formattedSlug } from '@/app/helpers';
...
export default function Index() {
  ...
  return (
    <Fragment>
      <Heads
        title={`Sewa ${formattedSlug(slug)} di Indonesia | Ada ${kontrakanList?.length || 0} properti di TempatSewa.Com
              Indonesia`}
      ...
      <section className="mb-5 mt-2">
        <div className="container">
          {/* Form Search */}
          <FormSearch page={true} kategori={slug} />

          {/* Placeholder hasil kategori */}
          <div className="my-5">
            <h3 className="fw-bold mb-2">Sewa {formattedSlug(slug)} di Indonesia</h3>
            <p className="text-muted mb-3">
              Ada <strong>{kontrakanList?.length || 0}</strong> properti di TempatSewa.Com Indonesia
            </p>
