...
const SyaratDanKetentuan = () => {
  return (
    <div className="container py-5 max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        Selamat datang di <strong>tempatSewa.Com</strong>. Dengan mengakses dan menggunakan platform
        kami, Anda dianggap telah membaca, memahami, dan menyetujui semua Syarat dan Ketentuan yang
        berlaku.
      </p>
      ...
      <p className="mb-4">
        Pemilik properti juga dapat menggunakan platform ini untuk memasarkan dan mengelola properti
        secara praktis dan efisien.
      </p>

      <h3 className="text-xl font-semibold mt-6 mb-2">2. Penggunaan Platform</h3>
      <ul className="list-disc ml-6 mb-4">
        <li>
          Pengguna wajib memberikan informasi yang akurat dan benar saat menggunakan layanan kami.
        </li>
      ...
      <p className="mb-4">
        tempatSewa.Com bertindak sebagai perantara antara pencari dan pemilik properti. Kami tidak
        bertanggung jawab atas kesepakatan, kerugian, atau perselisihan yang terjadi antara pengguna
        secara langsung.
      </p>

      <h3 className="text-xl font-semibold mt-6 mb-2">4. Hak Kekayaan Intelektual</h3>
      <p className="mb-4">
        Seluruh konten yang terdapat pada tempatSewa.Com (termasuk namun tidak terbatas pada teks,
        logo, gambar, dan desain) adalah milik kami dan dilindungi oleh undang-undang hak cipta.
        Dilarang menyalin atau menggunakan tanpa izin tertulis.
      </p>

      <h3 className="text-xl font-semibold mt-6 mb-2">5. Perubahan Layanan dan Syarat</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">6. Penutup</h3>
      <p className="mb-4">
        Dengan menggunakan tempatSewa.Com, Anda menyetujui seluruh ketentuan di atas. Jika Anda
        tidak menyetujui sebagian atau seluruh isi dari Syarat dan Ketentuan ini, mohon untuk tidak
