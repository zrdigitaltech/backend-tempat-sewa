          ...
          <div className="col-sm-12 col-md-6">
            <div className="number-services">
              <h3 data-aos="slide-right" data-aos-delay="0">
                <span className="size">{numberLayananList?.tahun_pengalaman}</span>
                <span className="total-text">
                  <span className="text">Tahun Lebih</span>
                  <span className="big-text">Pengalaman</span>
                </span>
              </h3>
              <p className="line" data-aos="slide-right" data-aos-delay="0">
                {numberLayananList?.description_pengalaman}
              </p>
              <div className="row">
                <div className="col-sm-4">
                  <div className="single-section" data-aos="flip-right" data-aos-delay="0">
                    <i className="fa fa-certificate" aria-hidden="true"></i>
                    <h3>Sertifikasi</h3>
                    <p>{numberLayananList?.certification_description}</p>
                  </div>
                </div>
                <div className="col-sm-4">
                  <div className="single-section" data-aos="flip-right" data-aos-delay="0">
                    ...
                    <h3>24/7 Layanan</h3>
                    <p>{numberLayananList?.operasional_description}</p>
                  </div>
                </div>
                <div className="col-sm-4">
                  <div className="single-section" data-aos="flip-right" data-aos-delay="0">
                    ...
                    <h3>
                      Harga <span className="text-responsive">Terjangkau</span>
                    </h3>
                    <p>{numberLayananList?.harga_wajar_description}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              {areaLayananList?.slice(0, 3).map((item, x) => (
                <div className="col-sm-4" key={item?.id || x}>
                  <div className="counter" data-aos="flip-right" data-aos-delay="0">
                    <div className="icon">
