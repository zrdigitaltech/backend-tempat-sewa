(() => {
  ...
  function Dn(t) {
    ...
    return (
      (!a || !Number.isFinite(a)) && (a = 1), (!d || !Number.isFinite(d)) && (d = 1), { x: a, y: d }
    );
  }
  var ga = nn(0);
  function Gi(t) {
  ...
  function ps(t, e, r, n, i, o, a, d) {
    ...
    return (
      (E = E || a), E && (f < w + (u * o) / 2 || f > m - (u * o) / 2) ? (f > w + u / 2 ? 1 : -1) : 0
    );
  }
  function hs(t) {
...
`,
      ...
      function W(c, s, b) {
        var _ = oe(c),
          ...
          H = L[1];
        return (
          (z = z || 0), (H = (H || 0) * T), [Z, X].indexOf(_) >= 0 ? { x: H, y: z } : { x: z, y: H }
        );
      }
      function B(c) {
        var s = c.state,
...
`,
      ...
      function or(g) {
        var y = J();
        return (
          g === !0 ? (y.className = a) : ((y.className = d), U(g) ? y.appendChild(g) : Ye(y, g)), y
        );
      }
      function kn(g, y) {
        U(y.content)
