(() => {
  (() => {
    var d = Object.defineProperty,
      ...
      o = {};
    f(o, { eager: () => g, event: () => w, idle: () => y, media: () => b, visible: () => E });
    var c = () => !0,
      g = c,
    ...
    var _ = '__internal_',
      l = {
        ...
        _generateRequirements(t, e) {
          ...
          return o[e.method] ? o[e.method]({ component: t, argument: e.argument }) : !1;
        },
        async _download(t) {
          if (t.startsWith(_) || (this._handleAlias(t), !this._data[t] || this._data[t].loaded))
            return;
