  ...
  var Oi = (l, h, a, c) => {
    if ((h && typeof h == 'object') || typeof h == 'function')
      for (let s of Ci(h))
        !Pi.call(l, s) &&
          s !== a &&
          he(l, s, { get: () => h[s], enumerable: !(c = Si(h, s)) || c.enumerable });
    return l;
  };
  var Ai = (l, h, a) => (
    (a = l != null ? ki(Ti(l)) : {}),
    Oi(h || !l || !l.__esModule ? he(a, 'default', { value: l, enumerable: !0 }) : a, l)
  );
  var _e = xi((yt, It) => {
    (function (h, a) {
        ...
        function (l, h, a) {
          ...
          function je() {
            for (var e = ['Pusher'], t = 0; t < arguments.length; t++)
              typeof arguments[t] == 'string' ? e.push(arguments[t]) : e.push(ct(arguments[t]));
            return e.join(' : ');
          }
          function qt(e, t) {
          ...
          var lr = function (e, t, n) {
              ...
              return (
                t.useTLS
                  ...
                  : (At = new St([ie, new ht(yi, { delay: 2e3 }), new ht(Ot, { delay: 5e3 })])),
              ...
              return (
                ...
                (e.prototype.sendRaw = function (t) {
                  if (this.readyState === $.OPEN)
                    try {
                      return (
                        m.createSocketRequest('POST', Kt(Sr(this.location, this.session))).start(t),
                        !0
                      );
                    } catch {
                      return !1;
                ...
                (e.prototype.onOpen = function (t) {
                  this.readyState === $.CONNECTING
                    ? (t && t.hostname && (this.location.base = Cr(this.location.base, t.hostname)),
            ...
            return (
              'channelAuthorization' in e
                ...
                : ((n = {
                  ...
                  'authorizer' in e && (n.customHandler = Qr(t, n, e.authorizer))),
              n
            );
          }
          function ri(e, t) {
      ...
      return (
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                s ? this.subscription.unbind_global(s) : this.subscription.unbind_global(), this
              );
            }
          },
          {
      ...
      return (
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                this.channels[s] || (this.channels[s] = new vt(this.pusher, s, this.options)),
                this.channels[s]
              );
            }
          },
      ...
      return (
        R(a, [
          ...
          },
          {
            ...
            value: function (s) {
              return (
                this.channels[s] || (this.channels[s] = new ve(this.socket, s, this.options)),
                this.channels[s]
              );
            }
          },
          ...
          },
          {
            ...
            value: function () {
              if (this.options.broadcaster == 'reverb')
                this.connector = new pe(st(st({}, this.options), { cluster: '' }));
              else if (this.options.broadcaster == 'pusher') this.connector = new pe(this.options);
              else if (this.options.broadcaster == 'socket.io')
                this.connector = new Di(this.options);
              else if (this.options.broadcaster == 'null') this.connector = new Hi(this.options);
