...
var Eo = (s, t) => (typeof s == 'string' && s.endsWith('%') ? parseFloat(s) / 100 : s / t),
  En = (s, t) => (typeof s == 'string' && s.endsWith('%') ? (parseFloat(s) / 100) * t : +s);
function j(s, t, e) {
...
function H(s, t, e, i) {
  ...
  else if (A(s)) for (o = Object.keys(s), r = o.length, n = 0; n < r; n++) t.call(e, s[o[n]], o[n]);
}
function ws(s, t) {
  let e, i, n, r;
...
function Ec(s, t, e) {
  ...
  let i = t[s],
    n = e[s];
  A(i) && A(n) ? Pe(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = ki(n));
}
...
var Ci = s => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
  ...
  Vo = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
function zn(s, t, e) {
  let i = t.length,
    n = 0,
    r = i;
  if (s._sorted) {
    ...
    u &&
      (n = it(Math.min(Ft(a, o.axis, c).lo, e ? i : Ft(t, l, o.getPixelForValue(c)).lo), 0, i - 1)),
      d
        ? (r =
            it(
              Math.max(
...
var bi = s => s === 0 || s === 1,
  ...
  Ce = {
    ...
    easeInOutBounce: s =>
      s < 0.5 ? Ce.easeInBounce(s * 2) * 0.5 : Ce.easeOutBounce(s * 2 - 1) * 0.5 + 0.5
  };
function Ss(s) {
  return (s + 0.5) | 0;
}
...
function Zc(s) {
  ...
  let n = Bo(+t[2]),
    ...
    o = +t[4] / 100;
  return (
    t[1] === 'hwb' ? (i = Uc(n, r, o)) : t[1] === 'hsv' ? (i = Yc(n, r, o)) : (i = $n(n, r, o)),
...
function Xc() {
  ...
  for (i = 0; i < t.length; i++) {
    for (o = a = t[i], n = 0; n < e.length; n++) (r = e[n]), (a = a.replace(r, xo[r]));
    (r = parseInt(_o[o], 16)), (s[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]);
  }
  return s;
}
var _i;
...
function th(s) {
  return (
    s && (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Vt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`)
  );
}
var kn = s => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
...
var Fe = class {
  constructor(t) {
    ...
    let e = typeof t,
      i;
    e === 'object' ? (i = wo(t)) : e === 'string' && (i = Wc(t) || Kc(t) || sh(t)),
      (this._rgb = i),
      (this._valid = !!i);
  }
  get valid() {
...
function st(s, t) {
  ...
  i && !('' + i).match(ah) && (console.warn('Invalid font style specified: "' + i + '"'), (i = ''));
  let n = {
...
function dh(s, t, e, i) {
  ...
  return a.add(s), (t = t(r, o || i)), a.delete(s), Gn(s, t) && (t = Xn(n._scopes, n, s, t)), t;
}
function fh(s, t, e, i) {
...
function Xn(s, t, e, i) {
  ...
  return l === null || (ft(r) && r !== e && ((l = So(a, o, r, l, i)), l === null))
    ? !1
...
function yh(s, t, e, i) {
  let n;
  for (let r of t) if (((n = Jo(hh(r, s), e)), ft(n))) return Gn(s, n) ? Xn(e, i, s, n) : n;
}
function Jo(s, t) {
  for (let e of t) {
    if (!e) continue;
...
function kh(s, t = 'x') {
  ...
  for (o = 0; o < i; ++o)
    if (((a = l), (l = c), (c = Le(s, o + 1)), !!l)) {
      ...
      r[o] = a ? (c ? (Tt(n[o - 1]) !== Tt(n[o]) ? 0 : (n[o - 1] + n[o]) / 2) : n[o - 1]) : n[o];
    }
  wh(s, n, r), Sh(s, r, t);
}
function Si(s, t, e) {
...
function Mh(s, t) {
  ...
  for (e = 0, i = s.length; e < i; ++e)
    (o = r),
      ...
      r &&
        ((n = s[e]),
        o && ((n.cp1x = Si(n.cp1x, t.left, t.right)), (n.cp1y = Si(n.cp1y, t.top, t.bottom))),
        a && ((n.cp2x = Si(n.cp2x, t.left, t.right)), (n.cp2y = Si(n.cp2y, t.top, t.bottom))));
}
    ...
    (b = t[O % o]),
      !b.skip &&
        ...
        y !== _ &&
          ...
          p !== null &&
            k() &&
            (m.push(To({ start: p, end: O, loop: d, count: o, style: f })), (p = null)),
          (v = O),
          (_ = y)));
...
var or = s => s === 'reset' || s === 'none',
  ...
  Jh = (s, t, e) => s && !t.hidden && t._stacked && { keys: Ja(e, !0), values: null },
  pt = class {
    constructor(t, e) {
      (this.chart = t),
        (this._ctx = t.ctx),
    ...
    parseObjectData(t, e, i, n) {
      let { xScale: r, yScale: o } = t,
        ...
        f;
      for (h = 0, u = n; h < u; ++h)
        (d = h + i), (f = e[d]), (c[h] = { x: r.parse(Bt(f, a), d), y: o.parse(Bt(f, l), d) });
      return c;
    }
    getParsed(t) {
    ...
    _update(t) {
      ...
      this.update(t || 'default'),
        (e._clip = Uh(C(this.options.clip, jh(e.xScale, e.yScale, this.getMaxOverflow()))));
    }
    update(t) {}
    draw() {
      let t = this._ctx,
...
function tu(s) {
  let t = s.iScale,
    ...
    a,
    l = () => {
      o === 32767 || o === -32768 || (ft(a) && (i = Math.min(i, Math.abs(o - a) || i)), (a = o));
    };
...
function eu(s, t, e, i) {
  let n = e.barThickness,
    ...
    o;
  return (
    N(n) ? ((r = t.min * e.categoryPercentage), (o = e.barPercentage)) : ((r = n * i), (o = 1)),
...
var $e = class extends pt {
  ...
  parseObjectData(t, e, i, n) {
    let { iScale: r, vScale: o } = t,
      ...
      g;
    for (d = i, f = i + n; d < f; ++d)
      (g = e[d]), (m = {}), (m[r.axis] = r.parse(Bt(g, c), d)), u.push(Qa(Bt(g, h), m, o, d));
    return u;
  }
  updateRangeFromParsed(t, e, i, n) {
  ...
  updateElements(t, e, i, n) {
    ...
    for (let f = e; f < e + i; f++) {
      let m = this.getParsed(f),
        g = r || N(m[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
...
var je = class extends pt {
  ...
  parseObjectData(t, e, i, n) {
    ...
    for (let o = 0; o < r.length; o++) {
      let a = e[i + o];
      r[o]._custom = C(a && a.r && +a.r, this.resolveDataElementOptions(o + i).radius);
    }
    return r;
  }
  getMaxOverflow() {
  ...
  resolveDataElementOptions(t, e) {
    ...
    let r = n.radius;
    return e !== 'active' && (n.radius = 0), (n.radius += C(i && i._custom, r)), n;
  }
};
je.id = 'bubble';
je.defaults = {
...
function ku(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    ...
    } else e === 'center' ? (m = (c.bottom + c.top) / 2 + g - t) : (m = ya(s, e, t));
    d = a - r;
  } else {
    if (A(e)) {
      let y = Object.keys(e)[0],
    ...
    } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = ya(s, e, t));
...
var Yt = class extends yt {
    ...
    calculateLabelRotation() {
      ...
      (a = t.offset ? this.maxWidth / i : f / (i - 1)),
        u + 6 > a &&
          ...
          (l = this.maxHeight - vs(t.grid) - e.padding - xa(t.title, this.chart.options.font)),
          (c = Math.sqrt(u * u + d * d)),
          (o = Di(
            Math.min(
    ...
    _convertTicksToLabels(t) {
      ...
      let e, i;
      for (e = 0, i = t.length; e < i; e++) N(t[e].label) && (t.splice(e, 1), i--, e--);
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, u = d.length; h < u; ++h)
            (_ = d[h]), !N(_) && !$(_) && ((y = _s(i, g.data, g.gc, y, _)), (b += p));
    ...
    _computeGridLineItems(t) {
      ...
      if (o === 'top')
        ...
        (y = p(this.top)), (F = t.top), (R = p(t.bottom) - g), (S = y + g), (O = this.top + u);
      else if (o === 'left')
        (y = p(this.right)), (x = this.right - u), (k = y - g), (v = p(t.left) + g), (W = t.right);
      else if (o === 'right')
        (y = p(this.left)), (v = t.left), (W = p(t.right) - g), (x = y + g), (k = this.left + u);
      else if (e === 'x') {
    ...
    _computeLabelItems(t) {
      ...
      e === 'y' && (l === 'start' ? (tt = 'top') : l === 'end' && (tt = 'bottom'));
    ...
    drawBorder() {
      ...
      let o = i.setContext(this.getContext(0)).lineWidth,
        ...
        u;
      this.isHorizontal()
        ? ((l = te(t, this.left, r) - r / 2), (c = te(t, this.right, o) + o / 2), (h = u = a))
        : ((h = te(t, this.top, r) - r / 2), (u = te(t, this.bottom, o) + o / 2), (l = c = a)),
        e.save(),
  ...
  Be = class {
    ...
    register(t) {
      ...
      return r in n || ((n[r] = t), Mu(t, o, i), this.override && L.override(t.id, t.overrides)), o;
    }
    get(t) {
      return this.items[t];
    }
    unregister(t) {
      let e = this.items,
        i = t.id,
        n = this.scope;
      i in e && delete e[i], n && i in L[n] && (delete L[n][i], this.override && delete Qt[i]);
    }
  };
function Mu(s, t, e) {
...
var pr = class {
  ...
  qe = class extends pt {
    ...
    addElements() {
      ...
      !this.datasetElementType && t && (this.datasetElementType = Rt.getElement('line')),
        super.addElements();
    }
    updateElements(t, e, i, n) {
      let r = n === 'reset',
      ...
      for (let w = e; w < e + i; ++w) {
        let x = t[w],
          ...
          F = (k[m] =
            r || O ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[m], w));
...
function cr(s, t, e, i, n, r) {
  return !r && !s.isPointInArea(t) ? [] : e === 'r' && !i ? Cu(s, t, e, n) : Iu(s, t, e, i, n, r);
}
...
function Cs(s, t, e, i) {
  ...
  for (r = 0, o = s.length, c = 0; r < o; ++r) {
    (a = s[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, zu(a.horizontal, t));
...
function Uu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver(r => {
      let o = !1;
      for (let a of r) (o = o || Yi(a.addedNodes, i)), (o = o && !Yi(a.removedNodes, i));
      o && e();
    });
...
function Yu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver(r => {
      let o = !1;
      for (let a of r) (o = o || Yi(a.removedNodes, i)), (o = o && !Yi(a.addedNodes, i));
      o && e();
    });
  return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
var br = class extends Ui {
  ...
  removeEventListener(t, e) {
    let i = t.$proxies || (t.$proxies = {}),
      n = i[e];
    if (!n) return;
    (({ attach: hr, detach: hr, resize: hr })[e] || $u)(t, e, n), (i[e] = void 0);
  }
  getDevicePixelRatio() {
...
function Ku(s) {
  return !Jn() || (typeof OffscreenCanvas < 'u' && s instanceof OffscreenCanvas) ? yr : br;
}
var xr = class {
  constructor() {
    this._init = [];
...
function td(s, { plugins: t, localIds: e }, i, n) {
  ...
  for (let a of t) {
    let l = a.id,
      c = Qu(i[l], n);
    c !== null && r.push({ plugin: a, options: ed(s.config, { plugin: a, local: e[l] }, c, o) });
  }
  return r;
}
...
function wr(s, t) {
  return s === 'x' || s === 'y' ? s : t.axis || nd(t.position) || s.charAt(0).toLowerCase();
}
function rd(s, t) {
...
var Es = (s, t, e) => {
  ...
  Sr = class {
    ...
    pluginScopeKeys(t) {
      let e = t.id,
        i = this.type;
      return zi(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
    }
    _cachedScopes(t, e) {
...
function Oa(s, t, e) {
  ...
  return (
    r ||
      ((r = { resolver: Li(t, e), subPrefixes: e.filter(a => !a.toLowerCase().includes('hover')) }),
      i.set(n, r)),
    r
  );
}
var ad = s => A(s) && Object.getOwnPropertyNames(s).reduce((t, e) => t || Ht(s[e]), !1);
function ld(s, t) {
...
function ll(s) {
  return (
    Jn() && typeof s == 'string' ? (s = document.getElementById(s)) : s && s.length && (s = s[0]),
...
var xe = class {
    constructor(t, e) {
      ...
      (this.platform = new (i.platform || Ku(n))()), this.platform.updateConfig(i);
    ...
    resize(t, e) {
      jt.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
    }
    _resize(t, e) {
      let i = this.options,
        n = this.canvas,
    ...
    setActiveElements(t) {
      ...
      !ws(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
    }
    notifyPlugins(t, e, i) {
    ...
    _handleEvent(t, e, i) {
      ...
      let h = !ws(a, n);
      return (
        (h || e) && ((this._active = a), this._updateHoverStyles(a, n, e)), (this._lastEvent = c), h
      );
    }
...
function yd(s, t, e) {
  let { x: i, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
    ...
    c = t.innerRadius + o,
    h;
  for (e && hl(s, t, r + B), s.beginPath(), s.arc(i, n, c, r + B, r, !0), h = 0; h < a; ++h)
    s.stroke();
...
function _d(s) {
  return s.stepped ? Zo : s.tension || s.cubicInterpolationMode === 'monotone' ? qo : xd;
}
function dl(s, t, e = {}) {
  let i = s.length,
...
function kd(s) {
  return s.stepped ? ia : s.tension || s.cubicInterpolationMode === 'monotone' ? na : Xt;
}
function Md(s, t, e, i) {
  let n = t._path;
...
var Nt = class extends yt {
  ...
  draw(t, e, i, n) {
    let r = this.options || {};
    (this.points || []).length && r.borderWidth && (t.save(), Od(t, this, i, n), t.restore()),
...
function Pd(s, t, e, i) {
  ...
  for (o = t; o < t + e; ++o) {
    ...
    if (x === h)
      ...
      o > 0 && S !== f && p.push(s[S]), p.push(a), (h = x), (r = 0), (m = g = c), (u = d = f = o);
    }
  }
  return p;
}
...
function tf(s) {
  ...
  if (i.grid.circular) {
    ...
    return new qi({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(o) });
  }
...
function fr(s, t, e) {
  ...
  i &&
    n.points.length &&
    (ks(s, e),
    ef(s, { line: n, target: i, above: h, below: u, area: e, scale: r, axis: o }),
    Ms(s));
}
function ef(s, t) {
...
var nf = {
    ...
    beforeDraw(s, t, e) {
      ...
      for (let o = n.length - 1; o >= 0; --o) {
        let a = n[o].$filler;
        a && (a.line.updateControlPoints(r, a.axis), i && a.fill && fr(s.ctx, a, r));
      }
    },
  ...
  Gi = class extends yt {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (let c of e)
          a !== c.row && ((a = c.row), (l = ot(i, this.left + n, this.right - this.lineWidths[a]))),
            (c.top += this.top + t + n),
        ...
        for (let c of e)
          c.col !== a &&
            ((a = c.col), (l = ot(i, this.top + t + n, this.bottom - this.columnSizes[a].height))),
            (c.top = l),
            (c.left += this.left + n),
      ...
      this.legendItems.forEach((k, O) => {
        ...
        l.setWidth(this.width),
          w
            ? O > 0 &&
              R + W + u > this.right &&
              ((tt = m.y += S), m.line++, (R = m.x = ot(r, this.left + u, this.right - i[m.line])))
            : O > 0 &&
              tt + S > this.bottom &&
              ((R = m.x = R + e[m.line].width + u),
              m.line++,
              (tt = m.y = ot(r, this.top + x + u, this.bottom - e[m.line].height)));
        let ct = l.x(R);
        b(ct, tt, k),
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        h =
          c +
          ot(t.align, this.top, this.bottom - m - t.labels.padding - this._computeTitleHeight());
      }
      let f = ot(a, u, u + d);
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Lt(t, this.left, this.right) && Lt(e, this.top, this.bottom)) {
        for (r = this.legendHitBoxes, i = 0; i < r.length; ++i)
          if (((n = r[i]), Lt(t, n.left, n.left + n.width) && Lt(e, n.top, n.top + n.height)))
...
var Sf = (s, t) => (s === null ? null : it(Math.round(s), 0, t)),
  Je = class extends Yt {
    ...
    parse(t, e) {
      ...
      let i = this.getLabels();
      return (
        (e = isFinite(e) && i[e] === t ? e : wf(i, t, C(e, t), this._addedLabels)),
        Sf(e, i.length - 1)
      );
    }
    determineDataLimits() {
...
function kf(s, t) {
  ...
  (v = Math.ceil(p / x) - Math.floor(g / x)),
    ...
    n === 'ticks' ? ((k = Math.floor(g / x) * x), (O = Math.ceil(p / x) * x)) : ((k = g), (O = p)),
    y && b && r && Ao((a - o) / r, x / 1e3)
      ? ((v = Math.round(Math.min((a - o) / x, h))), (x = (a - o) / v), (k = o), (O = a))
      : _
        ? ((k = y ? o : k), (O = b ? a : O), (v = c - 1), (x = (O - k) / v))
        : ((v = (O - k) / x),
          Re(v, Math.round(v), x / 1e3) ? (v = Math.round(v)) : (v = Math.ceil(v)));
  let F = Math.max(An(x), An(k));
  (S = Math.pow(10, N(l) ? F : l)), (k = Math.round(k * S) / S), (O = Math.round(O * S) / S);
  let W = 0;
  for (
    y &&
    (d && k !== o
...
Ws.id = 'logarithmic';
Ws.defaults = { ticks: { callback: Xi.formatters.logarithmic, major: { enabled: !0 } } };
function vr(s) {
  let t = s.ticks;
...
function Tf(s, t, e) {
  return (e = $(e) ? e : [e]), { w: Yo(s, t.string, e), h: e.length * t.lineHeight };
}
...
function vf(s) {
  ...
  s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (s._pointLabelItems = Df(s, i, n));
}
...
function Ff(s, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    let r = i.setContext(s.getPointLabelContext(n)),
      o = st(r.font),
      { x: a, y: l, textAlign: c, left: h, top: u, right: d, bottom: f } = s._pointLabelItems[n],
      { backdropColor: m } = r;
    if (!N(m)) {
...
function qa(s, t) {
  ...
  return (
    ...
    o === null
      ? null
      : (n &&
          (o = n === 'week' && (pe(r) || r === !0) ? e.startOf(o, 'isoWeek', r) : e.startOf(o, n)),
        +o)
  );
}
function Ga(s, t, e, i) {
...
function Nf(s) {
  for (let t = ut.indexOf(s) + 1, e = ut.length; t < e; ++t) if (Ki[ut[t]].common) return ut[t];
}
function Xa(s, t, e) {
  if (!e) s[t] = !0;
  else if (e.length) {
...
var we = class extends Yt {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : Nf(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
...
function Bi(s, t, e) {
  ...
  e
    ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = Ft(s, 'pos', t)),
      ({ pos: r, time: a } = s[i]),
      ({ pos: o, time: l } = s[n]))
    : (t >= s[i].time && t <= s[n].time && ({ lo: i, hi: n } = Ft(s, 'time', t)),
      ({ time: r, pos: a } = s[i]),
      ({ time: o, pos: l } = s[n]));
  let c = o - r;
...
var M = 'numeric',
  ...
  ii = { year: M, month: bt, day: M, hour: M, minute: M, second: M, timeZoneName: Dt },
  ni = { year: M, month: bt, day: M, weekday: bt, hour: M, minute: M, timeZoneName: bt },
  ri = { year: M, month: bt, day: M, weekday: bt, hour: M, minute: M, second: M, timeZoneName: bt };
var dt = class {
  get type() {
    throw new Ot();
  }
...
var Rr = class {
    constructor(t, e, i) {
      ...
      if (!e || Object.keys(o).length > 0) {
        ...
        i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = Uf(t, a));
      }
    }
    format(t) {
      if (this.inf) {
  ...
  Wr = class {
    constructor(t, e, i) {
      (this.opts = { style: 'long', ...i }), !e && an() && (this.rtf = Yf(t, i));
    }
    format(t, e) {
      return this.rtf
        ? this.rtf.format(t, e)
  ...
  P = class {
    static fromOpts(t) {
      return P.create(t.locale, t.numberingSystem, t.outputCalendar, t.weekSettings, t.defaultToEN);
    }
    ...
    months(t, e = !1) {
      return on(this, t, zr, () => {
        ...
        return (
          this.monthsCache[n][t] || (this.monthsCache[n][t] = Kf(r => this.extract(r, i, 'month'))),
      ...
      return on(this, t, Vr, () => {
        ...
        return (
          this.weekdaysCache[n][t] ||
            (this.weekdaysCache[n][t] = Jf(r => this.extract(r, i, 'weekday'))),
          this.weekdaysCache[n][t]
        );
      });
    }
      ...
      return on(
        ...
        () => {
          if (!this.meridiemCache) {
            ...
            this.meridiemCache = [T.utc(2016, 11, 13, 9), T.utc(2016, 11, 13, 19)].map(e =>
    ...
    getWeekSettings() {
      return this.weekSettings ? this.weekSettings : ln() ? qf(this.locale) : tm;
    }
    getStartOfWeek() {
...
function St({ numberingSystem: s }, t = '') {
  let e = s || 'latn';
  return ns[e] || (ns[e] = {}), ns[e][t] || (ns[e][t] = new RegExp(`${Ur[e]}${t}`)), ns[e][t];
}
var Tl = () => Date.now(),
  vl = 'system',
  Ol = null,
...
function li(s, t = 4, e = 1) {
  let { year: i, month: n, day: r } = s,
    ...
    c;
  return (
    l < 1 ? ((c = i - 1), (l = ke(c, t, e))) : l > ke(i, t, e) ? ((c = i + 1), (l = 1)) : (c = i),
...
function Gr(s) {
  ...
  return t ? (e ? (i ? !1 : kt('day', s.day)) : kt('month', s.month)) : kt('year', s.year);
}
function Xr(s) {
...
function Jr(s) {
  let t = Number(s);
  if (typeof s == 'boolean' || s === '' || Number.isNaN(t)) throw new J(`Invalid unit value ${s}`);
  return t;
}
function os(s, t) {
  let e = {};
        ...
        o = f =>
          t.isOffsetFixed && t.offset === 0 && f.allowZ
            ...
            : t.isValid
              ...
              : '',
        a = () => (i ? $l(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
        l = (f, m) => (i ? Ul(t, f) : r(m ? { month: f } : { month: f, day: 'numeric' }, 'month')),
        c = (f, m) =>
          i
            ? jl(t, f)
...
function bm(s, t) {
  return [{ year: as(s, t), month: as(s, t + 1, 1), day: as(s, t + 2, 1) }, null, t + 3];
}
function us(s, t) {
  return [
    {
...
var I = class {
  ...
  toFormat(t, e = {}) {
    ...
    return this.isValid ? X.create(this.loc, i).formatDurationFromString(this, t) : ac;
  }
  toHuman(t = {}) {
    ...
    let e = Te.map(i => {
      ...
      return D(n)
        ? null
        : this.loc
            .numberFormatter({ style: 'unit', unitDisplay: 'long', ...t, unit: i.slice(0, -1) })
            .format(n);
    }).filter(i => i);
    return this.loc
  ...
  plus(t) {
    ...
    let e = I.fromDurationLike(t),
      i = {};
    for (let n of Te) (he(e.values, n) || he(this.values, n)) && (i[n] = e.get(n) + this.get(n));
...
var U = class {
  ...
  toLocaleString(t = ae, e = {}) {
    return this.isValid ? X.create(this.s.loc.clone(e), t).formatInterval(this) : fs;
  }
  toISO(t) {
...
function It(s, t) {
  return s === null
    ? null
    : { regex: RegExp(s.map(Gm).join('|')), deser: ([e]) => s.findIndex(i => fc(e) === fc(i)) + t };
}
function mc(s, t) {
...
function uo(s) {
  return (
    s.localWeekData === null &&
      (s.localWeekData = li(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())),
    s.localWeekData
  );
}
function ve(s, t) {
...
function xc(s, t) {
  let e = s.o,
    ...
    r = {
      ...
      year: i,
      month: n,
      day: Math.min(s.c.day, rs(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7
    },
    o = I.fromObject({
...
function gs(s, t, e, i, n, r) {
  ...
  } else return T.invalid(new rt('unparsable', `the input "${n}" can't be parsed as ${i}`));
}
function mn(s, t, e = !0) {
  return s.isValid
    ? X.create(P.create('en-US'), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(s, t)
    : null;
}
function fo(s, t) {
...
function hg(s) {
  return yn[s] || (pn === void 0 && (pn = z.now()), (yn[s] = s.offset(pn))), yn[s];
}
function Sc(s, t) {
  ...
  T = class {
    ...
    static local() {
      let [t, e] = Mc(arguments),
        [i, n, r, o, a, l, c] = e;
      return Sc({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t);
    }
    static utc() {
      let [t, e] = Mc(arguments),
        [i, n, r, o, a, l, c] = e;
      return (
        ...
        Sc({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
      );
    }
    static fromJSDate(t, e = {}) {
      ...
      return n.isValid ? new T({ ts: i, zone: n, loc: P.fromObject(e) }) : T.invalid(pi(n));
    }
    static fromMillis(t, e = {}) {
      if (Ct(t))
        return t < -bc || t > bc
          ? T.invalid('Timestamp out of range')
          : new T({ ts: t, zone: Et(e.zone, z.defaultZone), loc: P.fromObject(e) });
      throw new J(
    ...
    static fromSeconds(t, e = {}) {
      if (Ct(t))
        return new T({ ts: t * 1e3, zone: Et(e.zone, z.defaultZone), loc: P.fromObject(e) });
    ...
    static fromFormat(t, e, i = {}) {
      if (D(t) || D(e)) throw new J('fromFormat requires an input string and a format');
    ...
    toLocaleString(t = ae, e = {}) {
      return this.isValid ? X.create(this.loc.clone(e), t).formatDateTime(this) : co;
    }
    toLocaleParts(t = {}) {
    ...
    toISOTime({
      ...
      return this.isValid ? (n ? 'T' : '') + _c(this, o === 'extended', e, t, i, r) : null;
    }
    toRFC2822() {
    ...
    toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: i = !0 } = {}) {
      let n = 'HH:mm:ss.SSS';
      return (e || t) && (i && (n += ' '), e ? (n += 'z') : t && (n += 'ZZ')), mn(this, n, !0);
    }
    toSQL(t = {}) {
    ...
    static min(...t) {
      if (!t.every(T.isDateTime)) throw new J('min requires all arguments be DateTimes');
      return Kr(t, e => e.valueOf(), Math.min);
    }
    static max(...t) {
      if (!t.every(T.isDateTime)) throw new J('max requires all arguments be DateTimes');
  ...
  return {
    ...
    initChart: function (i = null) {
      ...
      (Wt.defaults.animation.duration = 0),
        (Wt.defaults.backgroundColor = getComputedStyle(this.$refs.backgroundColorElement).color);
      let n = getComputedStyle(this.$refs.borderColorElement).color;
      (Wt.defaults.borderColor = n),
        (Wt.defaults.color = getComputedStyle(this.$refs.textColorElement).color),
