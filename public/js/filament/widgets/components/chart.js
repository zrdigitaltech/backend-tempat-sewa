...
function Pn(s, t, e) {
  ...
  if (s._sorted) {
    ...
    u &&
      (n = it(Math.min(Ct(a, o.axis, c).lo, e ? i : Ct(t, l, o.getPixelForValue(c)).lo), 0, i - 1)),
      d
        ? (r =
            it(
              Math.max(
...
function et(s, t) {
  ...
  i && !('' + i).match(sh) && (console.warn('Invalid font style specified: "' + i + '"'), (i = ''));
  let n = {
...
function xh(s, t) {
  ...
  for (e = 0, i = s.length; e < i; ++e)
    (o = r),
      ...
      r &&
        ((n = s[e]),
        o && ((n.cp1x = xi(n.cp1x, t.left, t.right)), (n.cp1y = xi(n.cp1y, t.top, t.bottom))),
        a && ((n.cp2x = xi(n.cp2x, t.left, t.right)), (n.cp2y = xi(n.cp2y, t.top, t.bottom))));
}
...
var Yt = class extends yt {
    ...
    update(t, e, i) {
      ...
      this._convertTicksToLabels(l ? ma(this.ticks, a) : this.ticks),
        ...
        o.display &&
          ...
          ((this.ticks = ou(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    calculateLabelRotation() {
      ...
      (a = t.offset ? this.maxWidth / i : f / (i - 1)),
        u + 6 > a &&
          ...
          (l = this.maxHeight - Ms(t.grid) - e.padding - ga(t.title, this.chart.options.font)),
          (c = Math.sqrt(u * u + d * d)),
          (o = Ti(
            Math.min(
    ...
    _computeGridLineItems(t) {
      ...
      if (o === 'top')
        ...
        (y = p(this.top)), (F = t.top), (P = p(t.bottom) - g), (S = y + g), (O = this.top + u);
      else if (o === 'left')
        (y = p(this.right)), (x = this.right - u), (k = y - g), (T = p(t.left) + g), (W = t.right);
      else if (o === 'right')
        (y = p(this.left)), (T = t.left), (W = p(t.right) - g), (x = y + g), (k = this.left + u);
      else if (e === 'x') {
  ...
  Be = class {
    ...
    register(t) {
      ...
      return r in n || ((n[r] = t), xu(t, o, i), this.override && L.override(t.id, t.overrides)), o;
    }
    get(t) {
      return this.items[t];
    }
...
function Gu(s, { plugins: t, localIds: e }, i, n) {
  ...
  for (let a of t) {
    let l = a.id,
      c = qu(i[l], n);
    c !== null && r.push({ plugin: a, options: Xu(s.config, { plugin: a, local: e[l] }, c, o) });
  }
  return r;
}
...
var Os = (s, t, e) => {
  ...
  br = class {
    constructor(t) {
      (this._config = ed(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map());
    }
    get platform() {
...
function ka(s, t, e) {
  ...
  return (
    r ||
      ((r = { resolver: Ci(t, e), subPrefixes: e.filter(a => !a.toLowerCase().includes('hover')) }),
      i.set(n, r)),
    r
  );
}
...
function nl(s) {
  return (
    qn() && typeof s == 'string' ? (s = document.getElementById(s)) : s && s.length && (s = s[0]),
...
var xe = class {
    ...
    setActiveElements(t) {
      ...
      !xs(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
    }
    notifyPlugins(t, e, i) {
      ...
      this.legendItems.forEach((k, O) => {
        ...
        l.setWidth(this.width),
          w
            ? O > 0 &&
              P + W + u > this.right &&
              ((Q = m.y += S), m.line++, (P = m.x = ot(r, this.left + u, this.right - i[m.line])))
            : O > 0 &&
              Q + S > this.bottom &&
    ...
    _getLegendItemAt(t, e) {
      ...
      if (At(t, this.left, this.right) && At(e, this.top, this.bottom)) {
        for (r = this.legendHitBoxes, i = 0; i < r.length; ++i)
          if (((n = r[i]), At(t, n.left, n.left + n.width) && At(e, n.top, n.top + n.height)))
...
function wf(s) {
  ...
  s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (s._pointLabelItems = kf(s, i, n));
}
...
var M = 'numeric',
  ...
  ii = { year: M, month: bt, day: M, weekday: bt, hour: M, minute: M, second: M, timeZoneName: bt };
var dt = class {
  get type() {
    throw new Ot();
  }
...
var Fr = class {
  ...
  N = class {
    static fromOpts(t) {
      return N.create(t.locale, t.numberingSystem, t.outputCalendar, t.weekSettings, t.defaultToEN);
    }
    ...
    months(t, e = !1) {
      return sn(this, t, Pr, () => {
        ...
        return (
          this.monthsCache[n][t] || (this.monthsCache[n][t] = Yf(r => this.extract(r, i, 'month'))),
      ...
      return sn(
        ...
        () => {
          if (!this.meridiemCache) {
            ...
            this.meridiemCache = [v.utc(2016, 11, 13, 9), v.utc(2016, 11, 13, 19)].map(e =>
...
function Zr(s) {
  let t = Number(s);
  if (typeof s == 'boolean' || s === '' || Number.isNaN(t)) throw new st(`Invalid unit value ${s}`);
  return t;
}
function rs(s, t) {
  let e = {};
  ...
  X = class {
    ...
    formatDateTimeFromString(t, e) {
      let i = this.loc.listingMode() === 'en',
        ...
        l = (f, m) => (i ? Wl(t, f) : r(m ? { month: f } : { month: f, day: 'numeric' }, 'month')),
        c = (f, m) =>
          i
            ? Rl(t, f)
...
function It(s, t) {
  return s === null
    ? null
    : { regex: RegExp(s.map(jm).join('|')), deser: ([e]) => s.findIndex(i => lc(e) === lc(i)) + t };
}
function cc(s, t) {
...
var v = class {
  ...
  static fromSeconds(t, e = {}) {
    if (zt(t)) return new v({ ts: t * 1e3, zone: Et(e.zone, z.defaultZone), loc: N.fromObject(e) });
