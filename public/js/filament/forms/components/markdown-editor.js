        ...
        this.iter(function (n) {
          n.gutterMarkers &&
            ...
            Pn(t, n, 'gutter', function () {
              return (
                (n.gutterMarkers[e] = null), Le(n.gutterMarkers) && (n.gutterMarkers = null), !0
              );
            });
        });
      }),
...
`),
    ...
    function T(w, W, E) {
      ...
      W = C(W, 'gm');
      for (
        var N, G = 1, J = w.getLine(E.line).length - E.ch, re = E.line, q = w.firstLine();
        re >= q;
...
var Vo = Ke((ws, Ss) => {
  (function (o) {
    ...
    function C(I) {
      ...
      return (
        (H == ')' || H == ']' || H == '}') && (I.indented = I.context.indented),
    ...
    Q('text/x-kotlin', {
      ...
      hooks: {
        ...
        indent: function (I, H, le, xe) {
          ...
          if (H.align && H.type == '}')
            return H.indented + (I.context.type == (le || '').charAt(0) ? 0 : xe);
        }
      },
    ...
    o.defineMode('cmake', function () {
      ...
      return {
        startState: function () {
          var b = {};
          return (
            (b.inDefinition = !1), (b.inInclude = !1), (b.continueString = !1), (b.pending = !1), b
          );
        },
        token: function (b, S) {
    ...
    o.defineMode('javascript', function (p, v) {
      ...
      return {
        startState: function (_) {
          ...
          return (
            v.globalVars && typeof v.globalVars == 'object' && (P.globalVars = v.globalVars), P
          );
        },
        token: function (_, P) {
          if (
      ...
      return function (d, k) {
        ...
        for (var W = y[k.state], E = 0; E < W.length; E++) {
          ...
          if (G) {
            ...
            var J = N.token;
            if (
              (J && J.apply && (J = J(G)), G.length > 2 && N.token && typeof N.token != 'string')
            ) {
              for (var re = 2; re < G.length; re++)
                G[re] &&
                  (k.pending || (k.pending = [])).push({ text: G[re], token: N.token[re - 1] });
      ...
      function (p, v) {
        ...
        function R(F, L) {
          ...
          if (pe === ']' && L.linkText) {
            ...
            var je = D(L);
            return (
              (L.linkText = !1), (L.inline = L.f = F.match(/\(.*?\)| ?\[.*?\]/, !1) ? x : R), je
            );
          }
  ...
  (function (o) {
    ...
    o.defineMode('jinja2', function () {
      ...
      function s(h, g) {
        ...
        if (g.incomment)
          return (
            h.skipTo('#}') ? (h.eatWhile(/\#|}/), (g.incomment = !1)) : h.skipToEnd(), 'comment'
          );
        if (g.intag) {
          if (g.operator) {
      ...
      function J(K, X) {
        ...
        if ((I && (X.indent = K.indentation()), I && S(X).type == 'py')) {
          ...
          if (K.eatSpace()) {
            ...
            return (
              le > H ? D(X) : le < H && R(K, X) && K.peek() != '#' && (X.errorToken = !0), null
            );
          } else {
            var xe = re(K, X);
    ...
    o.defineMode('ruby', function (g) {
      ...
      function c(E, N) {
        ...
        if (G == '%') {
          ...
          var O = E.eat(/[^\w\s=]/);
          return O
            ? (s.propertyIsEnumerable(O) && (O = s[O]), y(M(O, re, q, !0), E, N))
            : 'operator';
        } else {
          ...
          if (G == '?') {
            ...
            if (G == '|' && (N.varList || N.lastTok == '{' || N.lastTok == 'do'))
              return (T = '|'), null;
      ...
      function (p) {
        ...
        function J(q, O) {
          ...
          if (O.cursorHalf) {
            ...
            if (D === '$')
              return q.next(), q.eatWhile(/[\w-]/), z(q) && (O.cursorHalf = 0), 'variable-2';
            if (D === '!')
              return q.next(), (O.cursorHalf = 0), q.match(/^[\w]+/) ? 'keyword' : 'operator';
            ...
            if (q.eatWhile(/[\w-]/))
              if (q.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                ...
                return q.match(/ *:/, !1)
                  ...
                  : (q.match(/ *,/, !1) || N(O), 'tag');
            if (D === ':')
              return q.match(d) ? 'variable-3' : (q.next(), (O.cursorHalf = 1), 'operator');
          }
...
var ta = Ke(($u, Ku) => {
  (function (o) {
    ...
    o.defineMode('stylus', function (E) {
      ...
      function ke($, B, se, De) {
        return (
          (De = De >= 0 ? De : N), ($.context = new Ze(se, B.indentation() + De, $.context)), se
        );
      }
      function Je($, B) {
        var se = $.context.indent - N;
        return (
          (B = B || !1), ($.context = $.context.prev), B && ($.context.indent = se), $.context.type
        );
      }
      function He($, B, se) {
      ...
      return (
        (de.block = function ($, B, se) {
          ...
          if ($ == 'word') {
            ...
            if (ge == 'block-keyword')
              return (
                (ge = 'keyword'), B.current(/(if|unless)/) && !we(B) ? 'block' : ke(se, B, 'block')
              );
      ...
      return function (O, D, Q) {
        ...
        if (R == 'punctuation') {
          if (O.current() == '(') ++q;
            ...
            if (q == 0)
              return O.backUp(1), D.tokenize.pop(), D.tokenize[D.tokenize.length - 1](O, D);
            --q;
          }
        }
        return R;
