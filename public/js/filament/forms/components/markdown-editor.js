    ...
    o.defineMode('javascript', function (p, v) {
      ...
      return {
        startState: function (k) {
          ...
          return (
            v.globalVars && typeof v.globalVars == 'object' && (O.globalVars = v.globalVars), O
          );
        },
        token: function (k, O) {
          if (
      ...
      function (p, v) {
        ...
        function j(q, L) {
          ...
          if (pe === ']' && L.linkText) {
            ...
            var je = D(L);
            return (
              (L.linkText = !1), (L.inline = L.f = q.match(/\(.*?\)| ?\[.*?\]/, !1) ? _ : j), je
            );
          }
      ...
      function ee(K, X) {
        ...
        if ((I && (X.indent = K.indentation()), I && S(X).type == 'py')) {
          ...
          if (K.eatSpace()) {
            ...
            return (
              le > B ? D(X) : le < B && j(K, X) && K.peek() != '#' && (X.errorToken = !0), null
            );
          } else {
            var xe = re(K, X);
...
var ta = Ke(($u, Ku) => {
  (function (o) {
    ...
    o.defineMode('stylus', function (M) {
      ...
      function ke($, W, se, De) {
        return (
          (De = De >= 0 ? De : H), ($.context = new Ze(se, W.indentation() + De, $.context)), se
        );
      }
      function Je($, W) {
        var se = $.context.indent - H;
        return (
          (W = W || !1), ($.context = $.context.prev), W && ($.context.indent = se), $.context.type
        );
      }
      function He($, W, se) {
      ...
      return (
        (de.block = function ($, W, se) {
          ...
          if ($ == 'word') {
            ...
            if (ge == 'block-keyword')
              return (
                (ge = 'keyword'), W.current(/(if|unless)/) && !we(W) ? 'block' : ke(se, W, 'block')
              );
