var Mi = '2.1.5',
  ...
  St = {
    ...
    supportsInputEvents:
      typeof InputEvent < 'u' &&
      ['data', 'getTargetRanges', 'inputType'].every(n => n in InputEvent.prototype)
  },
  h = {
      ...
      switch (n) {
        ...
        default:
          ...
          let e = Math.floor(Math.log(n) / Math.log(t)),
            i = (n / Math.pow(t, e)).toFixed(this.precision).replace(/0*$/, '').replace(/\.$/, '');
  ...
  p = function (n) {
    ...
    return (u.destroy = () => a.removeEventListener(n, u, c)), a.addEventListener(n, u, c), u;
  },
  vt = function (n) {
    let {
        onElement: t,
  ...
  d = function (n) {
    ...
    if (
      (i.editable != null &&
        (i.attributes == null && (i.attributes = {}), (i.attributes.contenteditable = i.editable)),
      i.attributes)
    )
  ...
  $e = function (n) {
    ...
    return t
      ...
      : ot(n) ||
          (!ot(n.firstChild) &&
            (function (e) {
              return At().includes(x(e)) && !At().includes(x(e.firstChild));
            })(n));
  },
  ...
  qe = {
    ...
    pickFiles(n) {
      let t = d('input', { type: 'file', multiple: !0, hidden: !0, id: this.fileInputId });
...
`
  ...
  f = class {
    static proxyMethod(t) {
      ...
      this.prototype[e] = function () {
        ...
        return (
          i
            ? (a = o ? ((l = this[i]) === null || l === void 0 ? void 0 : l.call(this)) : this[i]())
            : r && (a = this[r]),
          o
  ...
  Hi =
    ((ce = Array.from) === null || ce === void 0 ? void 0 : ce.call(Array, '\u{1F47C}').length) ===
    1,
  zi = ((ue = ' '.codePointAt) === null || ue === void 0 ? void 0 : ue.call(' ', 0)) != null,
  _i =
...
var Ji = 0,
  ...
  Yi = function (n) {
    ...
    let e = Zi();
    return (
      e && t.setAttribute('nonce', e), document.head.insertBefore(t, document.head.firstChild), t
    );
  },
  Zi = function () {
  ...
  g = function (n) {
    if (n != null)
      return Array.isArray(n) || (n = [n, n]), [Ze(n[0]), Ze(n[1] != null ? n[1] : n[0])];
  },
  N = function (n) {
    if (n == null) return;
    let [t, e] = g(n);
  ...
  It = class extends f {
    ...
    stop() {
      if (this.started)
        return (
          (this.started = !1), document.removeEventListener('selectionchange', this.update, !0)
        );
    }
  ...
  bt = n =>
    n.replace(new RegExp(''.concat(te), 'g'), '').replace(new RegExp(''.concat(U), 'g'), ' '),
  ze = new RegExp('[^\\S'.concat(U, ']')),
  _e = n => n.replace(new RegExp(''.concat(ze.source), 'g'), ' ').replace(/\ {2,}/g, ' '),
  ti = function (n, t) {
  ...
  C = class extends O {
    ...
    getKeysCommonToHash(t) {
      return (t = ft(t)), this.getKeys().filter(e => this.values[e] === t.values[e]);
    }
    isEqualTo(t) {
    ...
    static groupObjects() {
      ...
      return (
        Array.from(e).forEach(s => {
          ...
          (a = s.canBeGrouped) !== null && a !== void 0 && a.call(s, i) ? (t = [s]) : o.push(s);
        }),
...
var M = class extends f {
  ...
  kt = class extends M {
    ...
    createNodes() {
      ...
      return (
        i &&
          ((t = d({ tagName: 'a', editable: !1, attributes: { href: i, tabindex: -1 } })),
          e.appendChild(t)),
    ...
    createCaptionElement() {
      ...
      if (e) t.classList.add(''.concat(W.attachmentCaption, '--edited')), (t.textContent = e);
      else {
        let i,
          r,
        ...
        if (
          ...
          let s = d({ tagName: 'span', className: W.attachmentName, textContent: i });
          t.appendChild(s);
        }
        if (r) {
          i && t.appendChild(document.createTextNode(' '));
          let s = d({ tagName: 'span', className: W.attachmentSize, textContent: r });
          t.appendChild(s);
        }
      }
      return t;
    ...
    getClassName() {
      let t = [W.attachment, ''.concat(W.attachment, '--').concat(this.attachment.getType())],
    ...
    getHref() {
      if (!ln(this.attachment.getContent(), 'a')) return this.attachment.getHref();
    }
    getCaptionConfig() {
      var t;
  ...
  ii = n =>
    d({ tagName: 'span', textContent: te, data: { trixCursorTarget: n, trixSerialize: !1 } }),
  ln = function (n, t) {
    let e = d('div');
  ...
  Nt = class extends kt {
    ...
    createContentNodes() {
      return (
        (this.image = d({ tagName: 'img', attributes: { src: '' }, data: { trixMutable: !0 } })),
    ...
    createCaptionElement() {
      ...
      return t.textContent || t.setAttribute('data-trix-placeholder', h.captionPlaceholder), t;
    }
    refresh(t) {
      var e;
      if (
...
`);
    ...
    createElement() {
      ...
      if (Object.keys(r).length) for (e in (t || (t = d('span')), r)) (i = r[e]), (t.style[e] = i);
      return t;
    }
    createContainerElement() {
  ...
  jt = class extends M {
    ...
    createNodes() {
      ...
      if (this.block.isEmpty()) t.push(d('br'));
        ...
        var e;
        let i = (e = v(this.block.getLastAttribute())) === null || e === void 0 ? void 0 : e.text,
          r = this.findOrCreateCachedChildView(Mt, this.block.text, { textConfig: i });
    ...
    createContainerElement(t) {
      ...
      if (
        ...
        i = ''.concat(ni.attachmentGallery, ' ').concat(ni.attachmentGallery, '--').concat(a);
      }
      return (
  ...
  ct = class extends M {
    ...
    render() {
      if (((this.childViews = []), (this.shadowElement = d('div')), !this.document.isEmpty())) {
        let t = Ct.groupObjects(this.document.getBlocks(), { asTree: !0 });
        Array.from(t).forEach(e => {
    ...
    didSync() {
      return this.elementStore.reset(ri(this.element)), He(() => this.garbageCollectCachedViews());
    }
...
(wt.prototype[(typeof Symbol == 'function' && Symbol.asyncIterator) || '@@asyncIterator'] =
  function () {
    return this;
  }),
...
var Wt = class extends at {
  ...
  H = class extends O {
    ...
    preloadFile() {
      if (this.file)
        return (
          (this.fileObjectURL = URL.createObjectURL(this.file)), this.preload(this.fileObjectURL)
        );
    }
...
E(z, 'permittedAttributes', ['caption', 'presentation']), j.registerType('attachment', z);
...
var ut = class extends O {
    ...
    splitObjectsAtRange(t) {
      ...
      return ([i, e] = new this.constructor(i).splitObjectAtPosition(pn(t) + o)), [i, r, e - 1];
    }
    ...
    consolidate() {
      ...
      return (
        this.objects.slice(1).forEach(i => {
          var r, o;
          (r = (o = e).canBeConsolidatedWith) !== null && r !== void 0 && r.call(o, i)
  ...
  R = class extends O {
    ...
    addAttributesAtRange(t, e) {
      return this.copyWithPieceList(
        this.pieceList.transformObjectsInRange(e, i => i.copyWithAdditionalAttributes(t))
      );
    }
    removeAttributeAtRange(t, e) {
      return this.copyWithPieceList(
        this.pieceList.transformObjectsInRange(e, i => i.copyWithoutAttribute(t))
      );
    }
    setAttributesAtRange(t, e) {
      return this.copyWithPieceList(
        this.pieceList.transformObjectsInRange(e, i => i.copyWithAttributes(t))
      );
    }
  ...
  S = class extends O {
    ...
    isListItem() {
      var t;
      return (t = v(this.getLastAttribute())) === null || t === void 0 ? void 0 : t.listAttribute;
    }
    isTerminalBlock() {
      var t;
      return (t = v(this.getLastAttribute())) === null || t === void 0 ? void 0 : t.terminal;
    }
    breaksOnReturn() {
      var t;
      return (t = v(this.getLastAttribute())) === null || t === void 0 ? void 0 : t.breakOnReturn;
    }
...
`),
  ...
  bn = function (n) {
    let t = !1,
      ...
      r = e[e.length - 1];
    return r
      ? ((i = i.map(o => (o.isBlockBreak() ? ((t = !0), xn(o)) : o))), t ? new R([...i, r]) : n)
      : n;
  },
...
`,
  ...
  k = class extends O {
    ...
    constructor() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
      super(...arguments), t.length === 0 && (t = [new S()]), (this.blockList = ut.box(t));
    }
    isEmpty() {
    ...
    insertTextAtRange(t, e) {
      ...
      return new this.constructor(
        s.blockList.editObjectAtIndex(r, a => a.copyWithText(a.text.insertTextAtPosition(t, o)))
      );
    }
    removeTextAtRange(t) {
      let e;
...
`
        ...
        let L,
          ...
          it = gt.appendText(P);
        L =
          a !== u && l === 0 && c.getAttributeLevel() >= A.getAttributeLevel()
            ? A.copyWithText(it)
            : c.copyWithText(it);
        let mt = u + 1 - a;
    ...
    moveTextFromRangeToPosition(t, e) {
      ...
      let [c, ...u] = s.getBlocks();
      return (
        u.length === 0 ? ((i = c.getTextWithoutBlockBreak()), l && (e += 1)) : (i = c.text),
        (a = a.insertTextAtRange(i, e)),
        u.length === 0
          ? a
          : ((s = new this.constructor(u)), (e += i.getLength()), a.insertDocumentAtRange(s, e))
      );
    }
    addAttributeAtRange(t, e, i) {
    ...
    addAttribute(t, e) {
      ...
      return (
        this.eachBlock((r, o) => (i = i.editObjectAtIndex(o, () => r.addAttribute(t, e)))),
    ...
    insertBlockBreakAtRange(t) {
      ...
      return (
        r === 0 && (e = [new S()]),
        new this.constructor(o.blockList.insertSplittableListAtPosition(new ut(e), i))
      );
    }
    ...
    removeLastTerminalAttributeAtRange(t) {
      ...
      return (
        this.eachBlockAtRange(t, function (i, r, o) {
          ...
          s && v(s).terminal && (e = e.editObjectAtIndex(o, () => i.removeAttribute(s)));
        }),
    ...
    removeBlockAttributesAtRange(t) {
      ...
      return (
        this.eachBlockAtRange(t, function (i, r, o) {
          i.hasAttributes() && (e = e.editObjectAtIndex(o, () => i.copyWithoutAttributes()));
        }),
        new this.constructor(e)
      );
    }
    expandRangeToLineBreaksAndSplitBlocks(t) {
      ...
      if (
        ((o.offset = l.findLineBreakInDirectionFromPosition('backward', o.offset)),
        o.offset != null &&
        ...
        (s.index -= 1), (s.offset = a.getBlockAtIndex(s.index).getBlockBreakPosition());
      else {
...
`
          ? (s.offset -= 1)
          : (s.offset = c.findLineBreakInDirectionFromPosition('forward', s.offset)),
          s.offset !== c.getBlockBreakPosition() &&
            ((e = a.positionFromLocation(s)), (a = a.insertBlockBreakAtRange([e, e + 1])));
      }
      return (
    ...
    eachBlockAtRange(t, e) {
      ...
      if (a.index === l.index)
        return (i = this.getBlockAtIndex(a.index)), (r = [a.offset, l.offset]), e(i, r, a.index);
      ...
      if (N(t)) return this.getCommonAttributesAtPosition(e);
      {
        ...
        return (
          this.eachBlockAtRange(t, function (o, s) {
            if (s[0] !== s[1]) return i.push(o.text.getCommonAttributesAtRange(s)), r.push(ci(o));
          }),
          C.fromCommonAttributesOfObjects(i).merge(C.fromCommonAttributesOfObjects(r)).toObject()
        );
      }
    }
  ...
  et = class extends f {
    ...
    parse() {
      try {
        this.createHiddenContainer(), lt.setHTML(this.containerElement, this.html);
    ...
    createHiddenContainer() {
      return this.referenceElement
        ...
        : ((this.containerElement = d({ tagName: 'div', style: { display: 'none' } })),
...
`);
      if (e === this.containerElement || this.isBlockElement(e)) {
        ...
        Q(r, (i = this.currentBlock) === null || i === void 0 ? void 0 : i.attributes) ||
...
`);
    ...
    processTextNode(t) {
      ...
      return (
        hi(t.parentNode) ||
          ((e = _e(e)),
          Ti((i = t.previousSibling) === null || i === void 0 ? void 0 : i.textContent) &&
            (e = kn(e))),
...
`,
        ...
        case 'img':
          ...
          let i = (r => {
            let o = r.getAttribute('width'),
              ...
              a = {};
            return o && (a.width = parseInt(o, 10)), s && (a.height = parseInt(s, 10)), a;
          })(t);
          for (let r in i) {
            let o = i[r];
            e[r] = o;
    ...
    getTextAttributes(t) {
      ...
      for (let r in Y) {
        let o = Y[r];
        if (o.tagName && q(t, { matchingSelector: o.tagName, untilNode: this.containerElement }))
          i[r] = !0;
        else if (o.parser) {
          if (((e = o.parser(t)), e)) {
            let s = !1;
        ...
        } else o.styleProperty && ((e = t.style[o.styleProperty]), e && (i[r] = e));
      }
      if ($(t)) {
    ...
    getBlockAttributes(t) {
      ...
      for (; t && t !== this.containerElement; ) {
        for (let r in y) {
          ...
          o.parse !== !1 &&
            x(t) === o.tagName &&
            (((i = o.test) !== null && i !== void 0 && i.call(o, t)) || !o.test) &&
    ...
    isBlockElement(t) {
      if (
        ...
        !$(t) &&
        !q(t, { matchingSelector: 'td', untilNode: this.containerElement })
      )
        return At().includes(x(t)) || window.getComputedStyle(t).display === 'block';
    }
    isInsignificantTextNode(t) {
      if (t?.nodeType !== Node.TEXT_NODE || !Rn(t.data)) return;
      let { parentNode: e, previousSibling: i, nextSibling: r } = t;
      return (yn(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || hi(e)
        ? void 0
        : !i || this.isBlockElement(i) || !r || this.isBlockElement(r);
    }
    isExtraBR(t) {
      return x(t) === 'br' && this.isBlockElement(t.parentNode) && t.parentNode.lastChild === t;
    }
    needsTableSeparator(t) {
      if (Tt.removeBlankTableCells) {
        var e;
        let i = (e = t.previousSibling) === null || e === void 0 ? void 0 : e.textContent;
        return i && /\S/.test(i);
      }
...
`,
    ...
    getMarginOfBlockElementAtIndex(t) {
      ...
      if (e && e.textContent && !At().includes(x(e)) && !this.processedElements.includes(e))
        return di(e);
    }
  ...
  Cn = function (n) {
    return x(n) === 'style' ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT;
  },
...
var Ut = class extends f {
    ...
    manageAttachment(t) {
      return (
        this.managedAttachments[t.id] || (this.managedAttachments[t.id] = new m(this, t)),
...
`)
  ...
  F = class extends f {
    ...
    insertDocument() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new k(),
...
`);
    ...
    replaceHTML(t) {
      let e = et.parse(t).getDocument().copyUsingObjectsFromDocument(this.document),
    ...
    deleteInDirection(t) {
      let e,
        ...
        l = N(a);
      if (
        (l ? (i = t === 'backward' && s[0].offset === 0) : (r = s[0].index !== s[1].index),
        i && this.canDecreaseBlockAttributeLevel())
      ) {
        let c = this.getBlock();
        if (
          (c.isListItem() ? this.decreaseListLevel() : this.decreaseBlockAttributeLevel(),
    ...
    moveTextFromRange(t) {
      ...
      return (
        this.setDocument(this.document.moveTextFromRangeToPosition(t, e)), this.setSelection(e)
      );
    }
    removeAttachment(t) {
    ...
    canSetCurrentAttribute(t) {
      return v(t) ? this.canSetCurrentBlockAttribute(t) : this.canSetCurrentTextAttribute(t);
    }
    canSetCurrentTextAttribute(t) {
      let e = this.getSelectedDocument();
      if (e) {
        for (let i of Array.from(e.getAttachments())) if (!i.hasContent()) return !1;
        return !0;
      }
    }
    ...
    setHTMLAtributeAtPosition(t, e, i) {
      ...
      let o = this.document.getBlockAtPosition(t),
        s = (r = v(o.getLastAttribute())) === null || r === void 0 ? void 0 : r.htmlAttributes;
    ...
    setTextAttribute(t, e) {
      ...
      if (r !== o) return this.setDocument(this.document.addAttributeAtRange(t, e, i));
      if (t === 'href') {
    ...
    setBlockAttribute(t, e) {
      ...
      if (this.canSetCurrentAttribute(t))
        return (
          this.setDocument(this.document.applyBlockAttributeAtRange(t, e, i)), this.setSelection(i)
        );
    }
    ...
    canIncreaseNestingLevel() {
      ...
      let e = this.getBlock();
      if (e) {
        if ((t = v(e.getLastNestableAttribute())) === null || t === void 0 || !t.listAttribute)
    ...
    getLocationRange(t) {
      return this.targetLocationRange
        ...
        : this.getSelectionManager().getLocationRange(t) || g({ index: 0, offset: 0 });
    }
...
var Et = class extends f {
  ...
  Tn = (n, t, e) => n?.description === t?.toString() && n?.context === JSON.stringify(e),
...
` &&
  ...
  Ht = class {
    ...
    loadJSON(t) {
      ...
      return (e = k.fromJSON(e)), this.loadSnapshot({ document: e, selectedRange: i });
    }
    loadSnapshot(t) {
      return (this.undoManager = new Et(this.composition)), this.composition.loadSnapshot(t);
    }
    getDocument() {
  ...
  zt = class {
    ...
    findLocationFromContainerAndOffset(t, e) {
      ...
      for (; l.nextNode(); ) {
        ...
        $e(c, { strict: i }) ? (o && s.index++, (s.offset = 0), (o = !0)) : (s.offset += ve(c));
      }
      return s;
    }
      ...
      if (r) {
        if (xt(r))
          ...
          if (((e = r.parentNode), !$e(r.previousSibling) && !le(e)))
            for (; r === e.lastChild && ((r = e), (e = e.parentNode), !le(e)); );
          (i = ae(r)), t.offset !== 0 && i++;
        }
        return [e, i];
      }
  ...
  Fn = function (n) {
    return Pn(n) === NodeFilter.FILTER_ACCEPT ? Fi(n) : NodeFilter.FILTER_REJECT;
  },
  Pn = function (n) {
  ...
  I = class extends f {
    constructor(t) {
      super(...arguments),
        ...
        (this.lockCount = 0),
        p('mousedown', { onElement: this.element, withCallback: this.didMouseDown });
    }
    getLocationRange() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return t.strict === !1
    ...
    selectionIsCollapsed() {
      var t;
      return ((t = yt()) === null || t === void 0 ? void 0 : t.collapsed) === !0;
    }
    selectionIsExpanded() {
    ...
    createLocationRangeFromDOMRange(t, e) {
      ...
      let i = this.findLocationFromContainerAndOffset(t.startContainer, t.startOffset, e);
      if (!i) return;
      let r = t.collapsed
        ? void 0
    ...
    pauseTemporarily() {
      ...
      let e = () => {
        ...
        i = setTimeout(e, 200);
      t = ['mousemove', 'keydown'].map(r => p(r, { onElement: document, withCallback: e }));
    }
    selectionDidChange() {
      if (!this.paused && !Ue(this.element)) return this.updateCurrentLocationRange();
    }
    ...
    getLocationAtPoint(t) {
      ...
      var i;
      if (e)
        return (i = this.createLocationRangeFromDOMRange(e)) === null || i === void 0
          ? void 0
          : i[0];
    }
...
var Pi = Object.freeze({
        ...
        E(
          ...
          xe(() => {
            ...
            return (
              ...
              p('click', { onElement: o, withCallback: this.didClickToolbar }),
              p('click', {
                onElement: o,
              ...
              { do: () => this.element.appendChild(o), undo: () => V(o) }
            );
          })
        ),
        E(
          ...
          xe(() => {
            ...
            p('input', { onElement: o, withCallback: a }),
              p('input', { onElement: o, withCallback: this.didInputCaption }),
              p('keydown', { onElement: o, withCallback: this.didKeyDownCaption }),
              p('change', { onElement: o, withCallback: this.didChangeCaption }),
              p('blur', { onElement: o, withCallback: this.didBlurCaption });
            ...
            return {
              do: () => {
                if (
                  ...
                  c.appendChild(o),
                  c.appendChild(s),
                  c.classList.add(''.concat(_.attachmentCaption, '--editing')),
      ...
      if (this.pendingCaption != null) {
        ...
        (this.pendingCaption = null),
          o
            ...
            : (i = this.delegate) === null ||
              i === void 0 ||
              (r = i.attachmentEditorDidRequestRemovingAttributeForAttachment) === null ||
              r === void 0 ||
  ...
  Kt = class extends f {
    constructor(t, e) {
      super(...arguments),
        ...
        (this.element = t),
        (this.composition = e),
        (this.documentView = new ct(this.composition.document, { element: this.element })),
        p('focus', { onElement: this.element, withCallback: this.didFocus }),
        p('blur', { onElement: this.element, withCallback: this.didBlur }),
        p('click', {
          onElement: this.element,
    ...
    installAttachmentEditorForAttachment(t, e) {
      var i;
      if (((i = this.attachmentEditor) === null || i === void 0 ? void 0 : i.attachment) === t)
        return;
  ...
  On = '['.concat(Ii, ']'),
  Mn = { attributes: !0, childList: !0, characterData: !0, characterDataOldValue: !0, subtree: !0 },
  Gt = class extends f {
    constructor(t) {
      super(t),
      ...
      if (i.length) {
        let r = i[0],
          ...
          s = (function (a, l) {
            ...
            return (
              (a = Z.box(a)),
              (l = Z.box(l)).length < a.length ? ([u, c] = ti(a, l)) : ([c, u] = ti(l, a)),
              { added: c, removed: u }
            );
...
`)
  ...
  jn = (n, t) => gi(n) === gi(t),
  Wn = new RegExp('('.concat('\uFFFC', '|').concat(te, '|').concat(U, '|\\s)+'), 'g'),
  ...
  ht = class extends f {
    constructor(t) {
      ...
      for (let e in this.constructor.events)
        p(e, { onElement: this.element, withCallback: this.handlerFor(e) });
    }
    elementDidMutate(t) {}
  ...
  w = class extends ht {
    ...
    mutationIsExpected(t) {
      ...
      let r = e != null ? e === this.inputSummary.textAdded : !this.inputSummary.textAdded,
        o = i != null ? this.inputSummary.didDelete : !this.inputSummary.didDelete,
        s =
          [
            `
`,
...
` && !o;
      if ((s && !a) || (a && !s)) {
        ...
        if (c) {
          var l;
          let u = s ? e.replace(/\n$/, '').length || -1 : e?.length || 1;
          if ((l = this.responder) !== null && l !== void 0 && l.positionIsBlockBreak(c[1] + u))
            return !0;
        }
      }
      return r && o;
    ...
    deleteInDirection(t, e) {
      var i;
      return ((i = this.responder) === null || i === void 0 ? void 0 : i.deleteInDirection(t)) !==
        !1
...
E(w, 'events', {
  ...
  cut(n) {
    ...
    if (
      ...
      (this.serializeSelectionToDataTransfer(n.clipboardData) && n.preventDefault(),
  ...
  paste(n) {
    ...
    if (!t || _n(n))
      return void this.getPastedHTMLUsingHiddenElement(D => {
        ...
        return (
          (e.type = 'text/html'),
          (e.html = D),
          (nt = this.delegate) === null || nt === void 0 || nt.inputControllerWillPaste(e),
          (re = this.responder) === null || re === void 0 || re.insertHTML(e.html),
          this.requestRender(),
          (oe = this.delegate) === null || oe === void 0 ? void 0 : oe.inputControllerDidPaste(e)
        );
      });
    let i = t.getData('URL'),
    ...
    if (i) {
      ...
      (e.type = 'text/html'),
        ...
        this.setInputSummary({ textAdded: D, didDelete: this.selectionIsExpanded() }),
        (a = this.responder) === null || a === void 0 || a.insertHTML(e.html),
        this.requestRender(),
        (l = this.delegate) === null || l === void 0 || l.inputControllerDidPaste(e);
    } else if (Ri(t)) {
      var c, u, b;
      (e.type = 'text/plain'),
        (e.string = t.getData('text/plain')),
        (c = this.delegate) === null || c === void 0 || c.inputControllerWillPaste(e),
        this.setInputSummary({ textAdded: e.string, didDelete: this.selectionIsExpanded() }),
        (u = this.responder) === null || u === void 0 || u.insertString(e.string),
        this.requestRender(),
        (b = this.delegate) === null || b === void 0 || b.inputControllerDidPaste(e);
    } else if (r) {
      var A, L, gt;
      (e.type = 'text/html'),
        (e.html = r),
        (A = this.delegate) === null || A === void 0 || A.inputControllerWillPaste(e),
        (L = this.responder) === null || L === void 0 || L.insertHTML(e.html),
        this.requestRender(),
        (gt = this.delegate) === null || gt === void 0 || gt.inputControllerDidPaste(e);
      ...
      if (D) {
        var mt, ie, ne;
        let nt = Vn(D);
        !D.name && nt && (D.name = 'pasted-file-'.concat(++qn, '.').concat(nt)),
          (e.type = 'File'),
          (e.file = D),
          (mt = this.delegate) === null || mt === void 0 || mt.inputControllerWillAttachFiles(),
          (ie = this.responder) === null || ie === void 0 || ie.insertFile(e.file),
          this.requestRender(),
          (ne = this.delegate) === null || ne === void 0 || ne.inputControllerDidPaste(e);
      }
    }
    n.preventDefault();
  },
...
var Vn = n => {
  ...
  Hn = !((ye = ' '.codePointAt) === null || ye === void 0 || !ye.call(' ', 0)),
  zn = function (n) {
    if (n.key && Hn && n.key.codePointAt(0) === n.keyCode) return n.key;
    {
      let t;
      if (
        (n.which === null ? (t = n.keyCode) : n.which !== 0 && n.charCode !== 0 && (t = n.charCode),
        t != null && Ni[t] !== 'escape')
      )
    ...
    start(t) {
      if (((this.data.start = t), this.isSignificant())) {
        ...
        this.inputSummary.eventName === 'keypress' &&
          ...
          ((i = this.responder) === null || i === void 0 || i.deleteInDirection('left')),
          ...
          ? (this.forgetPlaceholder(),
            this.canApplyToDocument()
              ? (this.setInputSummary({ preferDocument: !0, didInput: !1 }),
                ...
                (i = this.responder) === null || i === void 0 || i.setSelectedRange(this.range),
...
var G = class extends ht {
  ...
  activateAttributeIfSupported(t, e) {
    ...
    if (Le().includes(t))
      return (
        (i = this.delegate) === null || i === void 0 || i.inputControllerWillPerformFormatting(t),
        this.withTargetDOMRange(function () {
          var r;
...
E(G, 'events', {
  ...
  paste(n) {
    var t;
    let e,
      i = (t = n.clipboardData) === null || t === void 0 ? void 0 : t.getData('URL');
    return Oi(n)
      ? (n.preventDefault(), this.attachFiles(n.clipboardData.files))
      : $n(n)
        ? (n.preventDefault(),
          (e = { type: 'text/plain', string: n.clipboardData.getData('text/plain') }),
        ...
        : i
          ? (n.preventDefault(),
            ...
            (l = this.responder) === null || l === void 0 || l.insertHTML(e.html),
            this.render(),
            (c = this.delegate) === null || c === void 0 ? void 0 : c.inputControllerDidPaste(e))
          : void 0;
    var r, o, s, a, l, c;
  },
  beforeinput(n) {
  ...
  drop(n) {
    ...
    if (Ce(n)) {
      ...
      let r = ke(n);
      return (
        (i = this.responder) === null || i === void 0 || i.setLocationRangeFromPointRange(r),
  ...
  dragend() {
    var n;
    this.dragging &&
      ((n = this.responder) === null || n === void 0 || n.setSelectedRange(this.dragging.range),
      (this.dragging = null));
  },
  compositionend(n) {
    this.composing && ((this.composing = !1), St.recentAndroid || this.scheduleRender());
  }
}),
  E(G, 'keys', {
    ArrowLeft() {
      ...
      return (
        ...
        this.withTargetDOMRange(function () {
          ...
          this.deleteByDragRange =
            (n = this.responder) === null || n === void 0 ? void 0 : n.getSelectedRange();
        })
      );
    },
    ...
    insertFromPaste() {
      ...
      if (e) {
        ...
        this.event.preventDefault(),
          (t.type = 'text/html'),
          (t.html = i),
          (a = this.delegate) === null || a === void 0 || a.inputControllerWillPaste(t),
          this.withTargetDOMRange(function () {
            var l;
...
`);
    ...
    insertParagraph() {
      var n;
      return (
        (n = this.delegate) === null || n === void 0 || n.inputControllerWillPerformTyping(),
        this.withTargetDOMRange(function () {
          var t;
...
var Jn = function (n) {
    ...
    return (
      ...
      !(e => {
        ...
        return (
          ...
          i.getData('text/html').includes('urn:schemas-microsoft-com:office:office')
        );
      })(n)
    );
  },
  ...
  pi = (n, t) => (t || (t = rt(n)), n.querySelector("[data-trix-input][name='".concat(t, "']"))),
  fi = n => n.getAttribute('data-trix-action'),
  rt = n => n.getAttribute('data-trix-attribute') || n.getAttribute('data-trix-dialog-attribute'),
  Yt = class extends f {
    constructor(t) {
      super(t),
        (this.didClickActionButton = this.didClickActionButton.bind(this)),
        ...
        p('click', { onElement: this.element, matchingSelector: Xn, preventDefault: !0 }),
        p('click', {
          onElement: this.element,
          matchingSelector: Zn,
    ...
    eachActionButton(t) {
      return Array.from(this.element.querySelectorAll(Me)).map(e => t(e, fi(e)));
    }
    updateAttributes(t) {
    ...
    eachAttributeButton(t) {
      return Array.from(this.element.querySelectorAll(Oe)).map(e => t(e, rt(e)));
    }
    applyKeyboardCommand(t) {
      let e = JSON.stringify(t.sort());
      for (let i of Array.from(this.element.querySelectorAll('[data-trix-key]'))) {
        let r = i.getAttribute('data-trix-key').split('+');
        if (JSON.stringify(r.sort()) === e) return vt('mousedown', { onElement: i }), !0;
      }
      return !1;
    }
    dialogIsVisible(t) {
    ...
    setAttribute(t) {
      ...
      return i.willValidate && !i.checkValidity()
        ...
        : ((r = this.delegate) === null || r === void 0 || r.toolbarDidUpdateAttribute(e, i.value),
          this.hideDialog());
      var r;
    }
    removeAttribute(t) {
      ...
      let i = rt(t);
      return (
        (e = this.delegate) === null || e === void 0 || e.toolbarDidRemoveAttribute(i),
        this.hideDialog()
      );
    }
    hideDialog() {
      ...
      if (t)
        return (
          ...
          (e = this.delegate) === null || e === void 0
            ? void 0
            : e.toolbarDidHideDialog((i => i.getAttribute('data-trix-dialog'))(t))
        );
    }
    resetDialogInputs() {
  ...
  X = class extends $t {
    constructor(t) {
      ...
      super(...arguments),
        ...
        (this.inputController =
          qe.getLevel() === 2 ? new G(this.editorElement) : new w(this.editorElement)),
        (this.inputController.delegate = this),
        (this.inputController.responder = this.composition),
        (this.compositionController = new Kt(this.editorElement, this.composition)),
        (this.compositionController.delegate = this),
        (this.toolbarController = new Yt(this.editorElement.toolbarElement)),
        (this.toolbarController.delegate = this),
        (this.editor = new Ht(this.composition, this.selectionManager, this.editorElement)),
    ...
    compositionDidChangeAttachmentPreviewURL(t) {
      return (
        this.compositionController.invalidateViewForObject(t), this.notifyEditorElement('change')
      );
    }
    ...
    invokeAction(t, e) {
      return this.actionIsExternal(t)
        ...
        : (i = this.actions[t]) === null || i === void 0 || (i = i.perform) === null || i === void 0
          ? void 0
          : i.call(this);
      var i;
    }
    ...
    runEditorFilters() {
      ...
      if (
        ...
        !Pt(e.selectedRange, i.selectedRange) || !e.document.isEqualTo(i.document))
      )
    ...
    getTimeContext() {
      return Re.interval > 0 ? Math.floor(new Date().getTime() / Re.interval) : 0;
    }
    isFocused() {
      var t;
      return (
...
var Qn = Object.freeze({
  ...
  tr = Object.freeze({ __proto__: null, MutationObserver: Gt, SelectionChangeObserver: It }),
  er = Object.freeze({ __proto__: null, FileVerificationOperation: Xt, ImagePreloadOperation: Wt });
ki(
  'trix-toolbar',
  `%t {
  display: block;
...
var Qt = class extends HTMLElement {
    ...
    get labels() {
      ...
      this.id &&
        ...
        t.push(
          ...Array.from(
            this.ownerDocument.querySelectorAll("label[for='".concat(this.id, "']")) || []
          )
        );
    ...
    notify(t, e) {
      if (this.editorController) return vt('trix-'.concat(t), { onElement: this, attributes: e });
    }
    ...
    connectedCallback() {
      this.hasAttribute('data-trix-internal') ||
        ...
        this.editorController ||
          ...
          requestAnimationFrame(() => vt('trix-initialize', { onElement: this }))),
  ...
  T = {
    ...
    observers: tr,
    operations: er,
    elements: Object.freeze({ __proto__: null, TrixEditorElement: Qt, TrixToolbarElement: Zt }),
    filters: Object.freeze({ __proto__: null, Filter: Vt, attachmentGalleryFilter: Bi })
  };
Object.assign(T, Pi),
  (window.Trix = T),
  setTimeout(function () {
    customElements.get('trix-toolbar') || customElements.define('trix-toolbar', Zt),
      customElements.get('trix-editor') || customElements.define('trix-editor', Qt);
  }, 0);
T.config.blockAttributes.default.tagName = 'p';
T.config.blockAttributes.default.breakOnReturn = !0;
T.config.blockAttributes.heading = { tagName: 'h2', terminal: !0, breakOnReturn: !0, group: !1 };
T.config.blockAttributes.subHeading = { tagName: 'h3', terminal: !0, breakOnReturn: !0, group: !1 };
T.config.textAttributes.underline = {
  style: { textDecoration: 'underline' },
  inheritable: !0,
  parser: n => window.getComputedStyle(n).textDecoration.includes('underline')
};
