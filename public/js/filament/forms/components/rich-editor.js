...
`);
    ...
    setBlockAttribute(t, e) {
      ...
      if (this.canSetCurrentAttribute(t))
        return (
          this.setDocument(this.document.applyBlockAttributeAtRange(t, e, n)), this.setSelection(n)
        );
    }
...
var Kn = new WeakMap(),
  ...
  gi = class {
    ...
    checkValidity() {
      return (
        console.warn('This browser does not support checkValidity() for trix-editor elements.'), !0
      );
    }
    reportValidity() {
      return (
        console.warn('This browser does not support reportValidity() for trix-editor elements.'), !0
      );
    }
    setCustomValidity(t) {
      console.warn(
