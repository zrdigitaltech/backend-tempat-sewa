var Oi = '2.1.1',
  ...
  f = function (n) {
    ...
    return (u.destroy = () => a.removeEventListener(n, u, l)), a.addEventListener(n, u, l), u;
  },
  bt = function (n) {
    let {
        onElement: t,
...
`
  ...
  b = class {
    static proxyMethod(t) {
      ...
      this.prototype[e] = function () {
        ...
        return (
          i
            ? (a = o ? ((c = this[i]) === null || c === void 0 ? void 0 : c.call(this)) : this[i]())
            : r && (a = this[r]),
          o
  ...
  qi =
    ...
    1,
  Hi = ((ue = ' '.codePointAt) === null || ue === void 0 ? void 0 : ue.call(' ', 0)) != null,
  zi =
...
var _i = 0,
  ...
  C = class extends O {
    ...
    getKeysCommonToHash(t) {
      return (t = pt(t)), this.getKeys().filter(e => this.values[e] === t.values[e]);
    }
    isEqualTo(t) {
...
var M = class extends b {
  ...
  Ct = class extends M {
    ...
    getHref() {
      if (!nn(this.attachment.getContent(), 'a')) return this.attachment.getHref();
    }
    getCaptionConfig() {
      var t;
...
var ct = class extends O {
    ...
    splitObjectsAtRange(t) {
      ...
      return ([i, e] = new this.constructor(i).splitObjectAtPosition(un(t) + o)), [i, r, e - 1];
    }
...
`),
  ...
  dn = function (n) {
    let t = !1,
      ...
      r = e[e.length - 1];
    return r
      ? ((i = i.map(o => (o.isBlockBreak() ? ((t = !0), pn(o)) : o))), t ? new R([...i, r]) : n)
      : n;
  },
...
`,
  ...
  k = class extends O {
    ...
    constructor() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
      super(...arguments), t.length === 0 && (t = [new S()]), (this.blockList = ct.box(t));
    }
    isEmpty() {
...
`
    ...
    moveTextFromRangeToPosition(t, e) {
      ...
      let [l, ...u] = s.getBlocks();
      return (
        u.length === 0 ? ((i = l.getTextWithoutBlockBreak()), c && (e += 1)) : (i = l.text),
    ...
    insertBlockBreakAtRange(t) {
      ...
      return (
        r === 0 && (e = [new S()]),
        new this.constructor(o.blockList.insertSplittableListAtPosition(new ct(e), i))
      );
    }
...
`
          ? (s.offset -= 1)
          : (s.offset = l.findLineBreakInDirectionFromPosition('forward', s.offset)),
    ...
    eachBlockAtRange(t, e) {
      ...
      if (a.index === c.index)
        return (i = this.getBlockAtIndex(a.index)), (r = [a.offset, c.offset]), e(i, r, a.index);
...
`,
    ...
    getTextAttributes(t) {
      ...
      for (let r in Y) {
        let o = Y[r];
        if (o.tagName && V(t, { matchingSelector: o.tagName, untilNode: this.containerElement }))
          i[r] = !0;
        else if (o.parser) {
          if (((e = o.parser(t)), e)) {
            let s = !1;
    ...
    isBlockElement(t) {
      if (
        ...
        return vt().includes(x(t)) || window.getComputedStyle(t).display === 'block';
    }
    isInsignificantTextNode(t) {
      if (t?.nodeType !== Node.TEXT_NODE || !kn(t.data)) return;
      let { parentNode: e, previousSibling: i, nextSibling: r } = t;
      return (xn(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || hi(e)
        ? void 0
...
`,
    ...
    getMarginOfBlockElementAtIndex(t) {
      ...
      if (e && e.textContent && !vt().includes(x(e)) && !this.processedElements.includes(e))
        return di(e);
    }
...
var Ut = class extends b {
    ...
    manageAttachment(t) {
      return (
        this.managedAttachments[t.id] || (this.managedAttachments[t.id] = new p(this, t)),
...
`);
    ...
    deleteInDirection(t) {
      let e,
        ...
        c = N(a);
      if (
        (c ? (i = t === 'backward' && s[0].offset === 0) : (r = s[0].index !== s[1].index),
        i && this.canDecreaseBlockAttributeLevel())
      ) {
        let l = this.getBlock();
        if (
          (l.isListItem() ? this.decreaseListLevel() : this.decreaseBlockAttributeLevel(),
    ...
    getLocationRange(t) {
      return this.targetLocationRange
        ...
        : this.getSelectionManager().getLocationRange(t) || m({ index: 0, offset: 0 });
    }
...
var Et = class extends b {
  ...
  wn = (n, t, e) => n?.description === t?.toString() && n?.context === JSON.stringify(e),
  ...
  zt = class {
    ...
    findLocationFromContainerAndOffset(t, e) {
      ...
      for (; c.nextNode(); ) {
        ...
        $e(l, { strict: i }) ? (o && s.index++, (s.offset = 0), (o = !0)) : (s.offset += ve(l));
      }
      return s;
    }
  ...
  I = class extends b {
    constructor(t) {
      super(...arguments),
        ...
        (this.lockCount = 0),
        f('mousedown', { onElement: this.element, withCallback: this.didMouseDown });
    }
    getLocationRange() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      return t.strict === !1
    ...
    pauseTemporarily() {
      ...
      let e = () => {
        ...
        i = setTimeout(e, 200);
      t = ['mousemove', 'keydown'].map(r => f(r, { onElement: document, withCallback: e }));
    }
    selectionDidChange() {
...
var Pi = Object.freeze({
        ...
        E(
          ...
          xe(() => {
            ...
            f('input', { onElement: o, withCallback: a }),
              ...
              f('keydown', { onElement: o, withCallback: this.didKeyDownCaption }),
              f('change', { onElement: o, withCallback: this.didChangeCaption }),
  ...
  Kt = class extends b {
    constructor(t, e) {
      super(...arguments),
        ...
        (this.element = t),
        (this.composition = e),
        (this.documentView = new lt(this.composition.document, { element: this.element })),
  ...
  Nn = '['.concat(Ii, ']'),
  On = { attributes: !0, childList: !0, characterData: !0, characterDataOldValue: !0, subtree: !0 },
  Gt = class extends b {
    constructor(t) {
      super(t),
      ...
      if (i.length) {
        let r = i[0],
          ...
          s = (function (a, c) {
            ...
            return (
              (a = Z.box(a)),
              (c = Z.box(c)).length < a.length ? ([u, l] = ti(a, c)) : ([l, u] = ti(c, a)),
              { added: l, removed: u }
            );
...
`)
  ...
  Mn = (n, t) => gi(n) === gi(t),
  jn = new RegExp('('.concat('\uFFFC', '|').concat(te, '|').concat(U, '|\\s)+'), 'g'),
...
` && !o;
      if ((s && !a) || (a && !s)) {
        ...
        if (l) {
          var c;
          let u = s ? e.replace(/\n$/, '').length || -1 : e?.length || 1;
          if ((c = this.responder) !== null && c !== void 0 && c.positionIsBlockBreak(l[1] + u))
            return !0;
        }
      }
      return r && o;
...
E(w, 'events', {
  ...
  drop(n) {
    ...
    if (
      ...
      (c = this.responder) === null || c === void 0 || c.insertDocument(l), this.requestRender();
    }
  ...
  paste(n) {
    ...
    if (i) {
      ...
      (e.type = 'text/plain'),
        ...
        this.requestRender(),
        (g = this.delegate) === null || g === void 0 || g.inputControllerDidPaste(e);
    } else if (r) {
      var A, L, dt;
      (e.type = 'text/html'),
        (e.html = r),
        ...
        this.requestRender(),
        (dt = this.delegate) === null || dt === void 0 || dt.inputControllerDidPaste(e);
      ...
      if (D) {
        ...
        !D.name && nt && (D.name = 'pasted-file-'.concat(++Un, '.').concat(nt)),
          (e.type = 'File'),
          (e.file = D),
          (gt = this.delegate) === null || gt === void 0 || gt.inputControllerWillAttachFiles(),
      ...
      : Kn(n)
        ...
        : i
          ? (n.preventDefault(),
            ...
            this.render(),
            (l = this.delegate) === null || l === void 0 ? void 0 : l.inputControllerDidPaste(e))
          : void 0;
    var r, o, s, a, c, l;
  },
  beforeinput(n) {
    ...
    insertFromPaste() {
      ...
      if (i) {
        ...
        (l = u ? _e(u).trim() : i),
          ...
          (o = this.delegate) === null || o === void 0 || o.inputControllerWillPaste(e),
          this.withTargetDOMRange(function () {
            var g;
            return (g = this.responder) === null || g === void 0 ? void 0 : g.insertHTML(e.html);
          }),
          (this.afterRender = () => {
            var g;
        ...
        this.event.preventDefault(),
          ...
          this.withTargetDOMRange(function () {
            var l;
            return (l = this.responder) === null || l === void 0 ? void 0 : l.insertHTML(e.html);
          }),
          (this.afterRender = () => {
            var l;
            return (l = this.delegate) === null || l === void 0
        ...
        (e.type = 'File'),
          ...
          this.withTargetDOMRange(function () {
            var l;
            return (l = this.responder) === null || l === void 0 ? void 0 : l.insertFile(e.file);
          }),
          (this.afterRender = () => {
            var l;
            return (l = this.delegate) === null || l === void 0
...
var _n = function (n) {
  ...
  Jn = function (n) {
    let t = n.clipboardData;
    if (t) return t.types.includes('Files') && t.types.length === 1 && t.files.length >= 1;
  },
  Kn = function (n) {
    let t = n.clipboardData;
  ...
  Yt = class extends b {
    constructor(t) {
      super(t),
        ...
        f('click', { onElement: this.element, matchingSelector: Gn, preventDefault: !0 }),
        f('click', {
          onElement: this.element,
          matchingSelector: Yn,
    ...
    applyKeyboardCommand(t) {
      ...
      for (let i of Array.from(this.element.querySelectorAll('[data-trix-key]'))) {
        ...
        if (JSON.stringify(r.sort()) === e) return bt('mousedown', { onElement: i }), !0;
      }
      return !1;
    }
    dialogIsVisible(t) {
    ...
    constructor(t) {
      ...
      super(...arguments),
        ...
        (this.inputController =
          Ve.getLevel() === 2 ? new G(this.editorElement) : new w(this.editorElement)),
...
var Zn = Object.freeze({
  ...
  Qn = Object.freeze({ __proto__: null, MutationObserver: Gt, SelectionChangeObserver: It }),
  tr = Object.freeze({ __proto__: null, FileVerificationOperation: Xt, ImagePreloadOperation: Wt });
ki(
  'trix-toolbar',
  `%t {
  display: block;
...
var Qt = class extends HTMLElement {
    ...
    notify(t, e) {
      if (this.editorController) return bt('trix-'.concat(t), { onElement: this, attributes: e });
    }
    ...
    connectedCallback() {
      this.hasAttribute('data-trix-internal') ||
        ...
        this.editorController ||
          ...
          requestAnimationFrame(() => bt('trix-initialize', { onElement: this }))),
  ...
  T = {
    ...
    filters: Object.freeze({ __proto__: null, Filter: qt, attachmentGalleryFilter: Bi })
  };
Object.assign(T, Pi),
  (window.Trix = T),
  setTimeout(function () {
